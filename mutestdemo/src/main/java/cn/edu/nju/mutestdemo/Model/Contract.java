...
public class Contract extends Unit {
    ...
    public Object[] getBaseContracts() {
    ...
    public void setBaseContracts(Object[] baseContracts) {
        this.baseContracts = baseContracts;
    }

    public void setSubNodes(Object[] subNodes) {
    ...
    public void output() {
        ...
        System.out.println(subNodes.toString() + "ttttttttttttttttttttttttttttttttttttttttttttttttttttt");
        System.out.println("{");
        // 处理SubNotes
